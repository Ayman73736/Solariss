...
$sql = "SELECT * FROM `client` WHERE `client_clientid` = '$id'";
...
if (isset($_POST['edit_user']))
{
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        $sql = "UPDATE `client` SET `client_mail` = '$email', `client_streetnumber` = '$street_number', `client_street` = '$street_name', `client_zipcode` = '$zip_code', `client_city` = '$city', `client_country` = '$country', `client_cellphone` = '$cellphone' WHERE `client_clientid` = '$id'";
...
if (isset($_POST['change_password'])) {
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($test_result_row['client_clientlogin'] == $id
            ...
            $sql = "UPDATE `client` SET `client_clientpass` = '$new_password' WHERE `client_clientid` = '$id'";
