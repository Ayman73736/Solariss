...
<html lang="fr">
    <head>
        ...
        <title>Hôtel Solaris | Connectez-vous</title>
    ...
    <body>
                ...
                <section class="login__forms">
                    ...
                    <div class="container">
                        <form action="./model/signinModel.php" method="post" id="login__form-signin">
                            ...
                            <a href="./model/accountModel.php" class="form-link">Mot de passe oublié ?</a>
        ...
        <script type="text/javascript" src="./content/js/script.js">
        </script>
