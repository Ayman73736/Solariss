...
<html lang="fr">
    <head>
        ...
        <title>Hôtel Solaris | Nos chambres</title>
                ...
                <div id="bedrooms">
                    <div class="container">
                        <div class="bedrooms-content-card">
                            ...
                            <p>
                                L'hôtel Solaris offre toute une gamme de chambres décorées, simples, doubles, twin, avec ou sans salle de bains.
                            </p>
                            <a href="#gallery"><button>Voir les chambres</button></a>
                        </div>
                        <div class="bedrooms-content-card">
                            ...
                            <a href="stay.php"><button>Consulter nos tarifs</button></a>
                        </div>
                        <div class="bedrooms-content-card">
                            ...
                            <a href="about.php"><button>En savoir plus</button></a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="bedrooms-content-gallery left">
                            <div class="hover-effect">
                                ...
                                <div class="overlay">
                                    ...
                                    <a class="info" href="connect.php">Réserver</a>
                                </div>
                            </div>
                        </div>
